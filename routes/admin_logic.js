...
exports.get_individual = function(req, res, next) {
  var datetime = new Date();
 ...
 */
exports.get_report_total_sales_day = function(req, res, next) {
  var datetime = new Date();
  var thisYear = datetime.getFullYear();
...
exports.get_report_total_sales_week = function(req, res, next) {
  var datetime = new Date();
  var thisYear = datetime.getFullYear();
...
exports.get_report_total_sales_month = function(req, res, next) {
  var datetime = new Date();
  var thisYear = datetime.getFullYear();
...
exports.get_report_total_sales_day_by_product = function(req, res, next) {
  var datetime = new Date();
  var thisYear = datetime.getFullYear();
  var thisDay = datetime.getDate();
  var thisMonth = datetime.getMonth() + 1;
...
exports.get_report_total_sales_week_by_product = function(req, res, next) {
  var datetime = new Date();
  var thisYear = datetime.getFullYear();
  var week = Math.ceil(datetime.getDate() / 7);
  var thisMonth = datetime.getMonth() + 1;
...
exports.get_report_total_sales_month_by_product = function(req, res, next) {
  var datetime = new Date();
  var thisYear = datetime.getFullYear();
  var month = datetime.getMonth() + 1;
  var product = req.params.parameter;
